...
const char *generate_new_file_name(const char* old_file_name,char * new_file_name)
{
  ...
  if(!(*new_file_extension)) // if value of *ptr is '\0' , prove that no extension
   ...
   snprintf(new_file_name_full, sizeof(new_file_name_full), "%.*s_%s%s",file_name_length,old_file_name,current_time,(old_file_name+file_name_length));// oldname_time.ext
